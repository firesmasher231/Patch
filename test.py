...
def display_images_with_predictions(before_path, after_path, pred_before, pred_after):
    ...
    cv2.putText(img_before, f'Prediction: {label_before}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    cv2.putText(img_after, f'Prediction: {label_after}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
display_images_with_predictions(image_before_path, image_after_path, prediction_before, prediction_after)
