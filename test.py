...
image_before_path = os.path.join("dataset/test", "image7_before.jpg")
image_after_path = os.path.join("dataset/test", "image7_after.jpg")
...
prediction_before = model.predict(image_before)
prediction_after = model.predict(image_after)
